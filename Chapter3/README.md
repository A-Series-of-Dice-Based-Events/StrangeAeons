...
Designed for 4 Level 9 PCs

### H1. Caravanserai Exterior

### H2. Guard Station (Trivial/Low Threat)
1x [Denizen of Leng] (https://2e.aonprd.com/Monsters.aspx?ID=604)
2x Elite [Yeth Hound] (https://2e.aonprd.com/Monsters.aspx?ID=870)
Replace Vorpal Sword with [Luck Blade](https://2e.aonprd.com/Equipment.aspx?ID=390) 

### H4. Central Courtyard (Low Threat)

6x Elite [Nightgaunt](https://2e.aonprd.com/Monsters.aspx?ID=1247)

### H6. Shop (Trivial / Low Threat)
1x [Animate Dream](https://2e.aonprd.com/Monsters.aspx?ID=546)

Replace Symbol of Weakness trap with the following: 

Five Leng Rubys around the room cause nightmare visions to those who look at the gem. The animate dream shopkeeper uses the confusion caused by the rubys to attack the PCs. If he can defeat one of the PCs, he can be freed from being trapped at the shop, and the defeated PC will take his place. The impact of this is up to the GM. 

Nightmare Vision Leng Ruby
Complexity Simple
Stealth DC 27 (expert)
Description A gleaming gem shows all manner of dreams, many of them transmuting into a horrible nightmare involving the viewer or a loved one. 
Disable Thievery DC 29 (expert) to approach with eyes closed and cover or smash the gem. 
AC 27, Fort 0, Ref 0
Hardness 0, HP 1; Immunities critical hits, object immunities, precision damage
Nightmare Visions Reaction (mental, Visual); Trigger A creature views the gem. Effect 
The viewer must succeed at a DC 27 Will save or be confused for 1 round and take a –2 status penalty to Perception checks and saves against mental effects for 1d4 hours. On a critical failure, the penalty is instead –4.

### H7. Dining Hall (Low / Moderate Threat)
1x [Denizen of Leng] (https://2e.aonprd.com/Monsters.aspx?ID=604)
4x Elite [Yeth Hound] (https://2e.aonprd.com/Monsters.aspx?ID=870)
[Decanter of Endless Water](https://2e.aonprd.com/Equipment.aspx?ID=254)

### H9. Bookkeeper's Office (Moderate Threat)
Interweaving non-mathematical questions: Succesf DC 20
[Bogeyman](https://2e.aonprd.com/Monsters.aspx?ID=509)

### H10. Room of the Yellow King (Moderate Threat)
2x Denizen of Leng

### H11. Rooftop (Low Threat)
1x Elite [Shantak])(ttps://2e.aonprd.com/Monsters.aspx?ID=1293)
Convincing the Shantak: Treat them as unfriendly and use typical make an impression / make a request skill actions. 

Howdah of Leisurely Travel: use an [Explorer's Yurt](https://2e.aonprd.com/Equipment.aspx?ID=365) with the added benefit of a permanent 3rd level [endure elements](https://2e.aonprd.com/Spells.aspx?ID=99) spell.

## P. The Lunar Prison

### Travel to the Moon. Exposed to [severe cold](https://2e.aonprd.com/Equipment.aspx?Category=33) (12 to -20 degrees F). 

Rather than only three prisoners remaining, there are a number of surviving prisoners who have been converted to Hastur worship by Deanna Khatiri. 

Scaling the walls (smooth and greasy): Climb DC 40

Locked doors have good locks (five successes at DC 30)

### P1. Landing Paddock
Perception checks: 
DC 30 notice the submerged pipe
DC 32 notice another Giant Shantak arrived 
DC 34 two sets of footprints

### P2. (Moderate Threat)
1x [Leng Ghoul](https://2e.aonprd.com/Monsters.aspx?ID=1165)
Iron Portcullis 
Lift DC 30
Hardness 18, HP 72, BT (36)

3x Scroll: 5th level [Fireball](https://2e.aonprd.com/Spells.aspx?ID=119)
3x Scroll: [Dimension Door](https://2e.aonprd.com/Spells.aspx?ID=69)
...
### P4. Empty Guard Room
Replace wands of Scorching Ray with 3 wands of Paralyze

### P5. Occupied Guard Room (Moderate Threat)
3x Denizen of Leng
Each has a wand of Searing Light (heightened 5th)

### P6. Barracks (Low Threat)
This lock is a simple lock (three successful DC 20 Thievery checks)
1x Leng Ghoul
Chaos Emerald (currently has 8 charges): treat it as a staff with the following changes: 
	A. Spells held and charges used : 
		a. shield (1 charge)
		b. Befuddle (1 charge)
		c. circle of protection (against law only) (1 charge)
		d. Divine wrath (chaos only) (2 charges)
	B. Can be used by non spell caster
	C. The user gains the drained 1 condition for as long as they are holding the emerald
	D. The crystal automatically regains d3-1 charges per day. 
	
### P7. Administration (Severe Threat)
Replace Moon-Beast with 
1x [Chernobue Qlippoth](https://2e.aonprd.com/Monsters.aspx?ID=775)

Black Soul Shard Level 7
Necromancy Occult Consumable Talisman Magical

This dark gem attunes itself to the soul of its bearer. When carried close to the body of a creature, the gem harmlessly absorbs a portion of that creature’s life essence. If separated from its bearer for at least 1 day, the gem loses this attunement. If the bearer gains one or more levels of the drained condition, the black soul shard absorbs one of these levels into itself, reducing the condition by one.  

Absorbing a negative level destroys the portion of the soul within a black soul shard. This does not harm the creature, but requires re-attuning the gem for 24 hours for it to function again. A creature can only have one black soul shard attuned to it at a time.
...
+1 Striking Longbow
+1 Chain shirt
[Glamorous Buckler](https://2e.aonprd.com/Equipment.aspx?ID=734)

Elf Wizard's gear 
8x [Starshot Arrows](https://2e.aonprd.com/Equipment.aspx?ID=772)

### P9. Shifting Hall
10 foot thick wall stats:

Hardness 14, HP 1800, BT (900) (In practical terms it can be demolished with tools and 8 person hours of work. Most importantly they'll be met with an ambush by the dragon and the demons when they come through the other side. 
...
HP 197
Speed 25 feet; fly 25
Melee Single Action fist blades +20 [+16/+12] (agile), Damage 2d6+8 piercing
Ranged Single Actions Blades +20 [+15/+10] (Range 30 feet), Damage 2d10+8 Piercing
Blade shower two actions  Kelvetta shoots a shower of blades that deals 4d6+7 piercing damage to all creatures in a 15-foot cone (DC 28 basic Reflex save)
Flailing Thrash Two Actions Kelvetta brix makes two fist blade Strikes, with each Strike dealing an extra 1d6 damage against creatures grabbing or grabbed by her. The multiple attack penalty doesn't increase until after both attacks.
Unnatural Leap Single Action The Kelvetta brix jumps up to her Speed horizontally, or half that vertically

Deanna Khatiri
Use [Cult Leader](https://2e.aonprd.com/NPCs.aspx?ID=930)
 
7x [Cultists](https://2e.aonprd.com/NPCs.aspx?ID=927)

These are Hastur worshipers so will be interested in the party members marked with Yellow signs. 

Removing the grate: 
Force open DC 30
Hardness, HP (BT) 18, 72 (36)
...
### P14. Torture Chamber (Severe Threat)
Orsephelius: 
Use [Elite Peluda](https://2e.aonprd.com/Monsters.aspx?ID=756)

Note: once Orsephelius is at 50% HP (or 25% HP and the torture devices are destroyed), she steps into a shadow and disappears. She will wait outside for the PCs and attack them where she has more room to maneuver. 

Living Torture Devices:
Use 4x [Animate Statues](https://2e.aonprd.com/Monsters.aspx?ID=20)

Treasure: 
Spectacles of Understanding
Use [Goggles of Night](https://2e.aonprd.com/Equipment.aspx?ID=438)

Death Scream Preserving Apparatus
While it is operative: 
Every turn, living creatures (except those who have become accustomed to it by exposure for over 24 hours) within 50 feet must attempt a DC 28 Will save.
Critical Success The creature is unaffected.
Success The creature is frightened 1.
Failure The creature is frightened 2.
Critical Failure The creature is frightened 2 and takes a –2 status penalty to saving throws against Fear .


DC 25 Arcana or Occult to Deduce the nature of the machine
Disable device: five successes at DC 30 to disable the apparatus
hardness 5, hp 60(BT 30), break DC 25

Breaking the Apparatus or Failing the disable device: 
Each living creature in the area takes 4d8+9 negative damage and must attempt a Fortitude save DC 26.
Critical Success The creature is unaffected.
Success The creature takes full damage.
Failure The creature takes full damage and is drained 1.
Critical Failure The creature takes double damage and is drained 1d4.

### P16. Solitary Cells
This area is under the effect of a permanent Silence spell cast as a 9th level spell, counteract DC 36.

The Yellow King:
Use [Sage](https://2e.aonprd.com/NPCs.aspx?ID=950)

### P17. Pipes Room (Severe / Extreme Threat)
Maenads:
Use 1x [Munagola](https://2e.aonprd.com/Monsters.aspx?ID=1115) and 1x [Phistophilus](https://2e.aonprd.com/Monsters.aspx?ID=112)

These two (a contract demon and an executioner demon) have entered into a profitable arrangement with Ahrhk-Nar: he tortures the prisoners see how much they can withstand. At what point will they sign a contract with a demon, binding their souls, in order to escape their fleshly torment? Once they have signed their souls away, their current torment is quickly ended, as the Munagola executes them. But what torment awaits them the realm of the devils? 

The piped screams are louder and the effect is stronger here: use the stats from the Torture chamber, but increase the DC to 28.

### P18. Music Room (Severe Threat)
Ahrhk-Nar: 
1x [Chernobue Qlippoth](https://2e.aonprd.com/Monsters.aspx?ID=775)
...
Treasure: 
Atonement ritual (this will be necessary to atone for the past sins of the PCs). 

## Q. The Reflective Oasis

6 hours of travel through [Severe Heat](https://2e.aonprd.com/Rules.aspx?ID=590)
The yellow King provides enough Endure elements for everyone for the entire journey. 

### Q1. Oasis Guardian (Moderate Threat)

Jinmenju: 
Use modified Elite [Dezullon](https://2e.aonprd.com/Monsters.aspx?ID=115)

N Huge Plant
Perception +20; low-light vision
Skills Acrobatics +23, Athletics +21, Stealth +23 
Str +5, Dex +7, Con +3, Int -4, Wis +2, Cha -1
AC 32; Fort +19, Ref +23, Will +18
HP 150 (regeneration 15 (deactivated by fire)); Resistances acid 20
...
Speed 0 feet
Melee Single Action vine +23 (acid, agile), Damage 3d6+10 bludgeoning plus 3d6 acid and Grab
Ranged Single Action acid glob +25 (acid, range 30 feet), Damage 3d8+6 acid plus amnesia venom
Amnesia Venom (mental, poison) Saving Throw DC 31 Fortitude; Maximum Duration 6 rounds; Stage 1 flat-footed (1 round); Stage 2 flat-footed and clumsy 1 (1 round); Stage 3 confused, flat-footed, and clumsy 2 (1 round).
Constrict Single Action 2d6+6 bludgeoning

### Q2. Mad Poet's Hut

Mad Poet
Use modified Rakhasha Maharaja: 
https://2e.aonprd.com/Monsters.aspx?ID=1272
Replace Fangs with ranged attack: 
Words that No Man Was Meant to Know (same stats, but mental damage and ranged increment 30 ft)
Replace Four  Fanged Assault with Glimpse of the Unspeakable (four Words that no Man was Meant to Know attacks).
Replace Fiend, Rakahasa with Human, Dream
